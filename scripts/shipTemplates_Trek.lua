...
template:setTubes(1, 9.5) -- Amount of torpedo tubes, and loading time of the tubes.
...
template:setBeam(0, 81, 0, 800.0, 5.0, 10)
...
template:setTubeDirection(0, 0):weaponTubeDisallowMissle(3, "Mine")
...
template:setTubes(4, 10) -- Amount of torpedo tubes, and loading time of the tubes.
template:setHull(250)
...
template:setBeam(0, 100, 0, 700.0, 6.0, 7)
template:setBeam(1, 100, 180, 500.0, 6.0, 6)
...
template:setBeam(1, 80,  180, 400.0, 8.0, 6)
...
template:setTubeDirection(1, 1):setWeaponTubeExclusiveFor(1, "Homing")
template:setTubeDirection(2,-1):setWeaponTubeExclusiveFor(2, "Homing")
template:setBeam(0, 80, 0, 800.0, 8.0, 10)
template:setBeam(1, 60,  180, 500.0, 8.0, 10)
